...
router.post('/demo/start', verifyJwt, maintenanceBlock, driverController.startDemo);
...
router.post('/pickups/:donationId/accept', verifyJwt, maintenanceBlock, driverController.acceptPickup);
